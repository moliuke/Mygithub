...
typedef enum __err
{
	...
	ERR_NOTEXIST,				//²»´æÔÚ
	ERR_ISEMPTY,
	ERR_MOLLOC_FAILED,			//¶¯Ì¬·ÖÅäÄÚ´æÊ§°Ü
	ERR_OPEN_FAILED,			//´ò¿ªÊ§°Ü
	ERR_STRING_NOTEQU,			//×Ö·û´®²»Ò»ÖÂ
	ERR_FILE_NOTEXIST,			//ÎÄ¼ş²»´æÔÚ
	ERR_USER_NOTEXIST,			//ÓÃ»§²»´æÔÚ
	ERR_SOCKET_SHUTDOWN,		//socket¹Ø±Õ
	ERR_UNKNOWN					//²»Ã÷´íÎó
}err_t;
